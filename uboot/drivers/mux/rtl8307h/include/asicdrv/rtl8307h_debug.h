...
//#define DBG_MASK         DBG_ERR|DBG_VERIF|DBG_INFO
#define DBG_MODULE_MASK  DBG_PKTTRANSLATOR|DBG_PRI|DBG_MIRROR
...
#define DEBUG_INFO(type,fmt, args...) \
    do {if(type & (DBG_MODULE_MASK)) rtlglue_printf("[%s-%d]-info-: " fmt "\n", __FUNCTION__, __LINE__, ## args);} while (0)
#else
