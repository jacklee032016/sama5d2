...
int32  _rtl8307h_vlanTbl_param2entry(rtl8307h_tblasic_vlan_entry_t *pEntry,  rtl8307h_vlanTbl_param_t* pVlanParam)
{
...
int32 _rtl8307h_vlanTbl_entry2Param(const rtl8307h_tblasic_vlan_entry_t *pEntry, rtl8307h_vlanTbl_param_t *pVlanParam, uint16 index)
{
...
int32 _rtl8307h_vlanCam_param2entry(rtl8307h_tblasic_vlanCam_entry_t *pEntry,  rtl8307h_vlanTbl_param_t *pVlanParam)
{
...
int32 _rtl8307h_vlanCam_entry2Param(const rtl8307h_tblasic_vlanCam_entry_t *pEntry, rtl8307h_vlanTbl_param_t *pVlanParam)
{
    memset(pVlanParam, 0, sizeof(rtl8307h_vlanTbl_param_t));
