...
#define RX_USER_INIT           1 //0  /*Always set to 0. Set to 1 for customer initialisation custimization only. */
...
#define RX_I2C_AFE_DPLL_MAP_ADDR        0x24 // 0x30
#define RX_I2C_ESDP_MAP_ADDR            0x26 // 0x34    /* Def 0x70 */
