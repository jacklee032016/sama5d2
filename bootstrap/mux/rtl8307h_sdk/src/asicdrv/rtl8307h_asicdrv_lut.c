...
int32 _rtl8307h_lut_hash0_unicast_index_get(const rtl8307h_lut_uni_param_t* param, rtl8307h_lut_4way_idx_t idx)
{
    uint16 index;
    uint16 key[7];
    uint16 tmp;
...
int32 _rtl8307h_lut_hash0_multicast_index_get(const rtl8307h_lut_multi_param_t* param, rtl8307h_lut_4way_idx_t idx)
{
    uint16 index;
    uint16 key[7];
...
int32 _rtl8307h_lut_hash0_ip_index_get(const rtl8307h_lut_ipMulti_param_t* param, rtl8307h_lut_4way_idx_t idx)
{
    uint16 index;
    uint16 key[7];
...
int32 _rtl8307h_lut_hash_group_index_get(const rtl8307h_lut_group_param_t* param, rtl8307h_lut_8way_idx_t idx)
{
    uint16 index;
    uint16 key[7];
...
int32 _rtl8307h_lut_hash0_index_get(const rtl8307h_lut_param_t* param, rtl8307h_lut_4way_idx_t idx)
{
...
void _rtl8307h_addrTbl_hash0_unicast_restore(uint16 index, rtl8307h_lut_uni_param_t* param)
{
    uint16 restore_bits;
    uint16 key[7];
    uint16 tmp;
...
void _rtl8307h_addrTbl_hash0_multi_restore(uint16 index, rtl8307h_lut_multi_param_t* param)
{
    uint16 restore_bits;
    uint16 key[7];
    uint16 tmp;
...
void _rtl8307h_addrTbl_hash0_ip_restore(uint16 index, rtl8307h_lut_ipMulti_param_t* param)
{
    uint16 restore_bits;
    uint16 key[7];
    uint16 tmp;
...
/* calculate index using hash algorithm */
int32 _rtl8307h_lut_hash1_unicast_index_get(const rtl8307h_lut_uni_param_t* param, rtl8307h_lut_4way_idx_t idx)
{
    uint16 index;
    uint16 key[7];
    uint16 tmp;
...
int32 _rtl8307h_lut_hash1_multicast_index_get(const rtl8307h_lut_multi_param_t* param, rtl8307h_lut_4way_idx_t idx)
{
    uint16 index;
    uint16 key[7];
...
int32 _rtl8307h_lut_hash1_ip_index_get(const rtl8307h_lut_ipMulti_param_t* param, rtl8307h_lut_4way_idx_t idx)
{
    uint16 index;
    uint16 key[7];
...
int32 _rtl8307h_lut_hash1_index_get(const rtl8307h_lut_param_t* param, rtl8307h_lut_4way_idx_t idx)
{
    if (param->type == LUT_UNICAST)
    {
...
/* restore the bits in LUT using reverse hash algorithm */
void _rtl8307h_addrTbl_hash1_unicast_restore(uint16 index, rtl8307h_lut_uni_param_t* param)
{
    uint16 restore_bits;
    uint16 key[7];
    uint16 tmp;
...
void _rtl8307h_addrTbl_hash1_multi_restore(uint16 index, rtl8307h_lut_multi_param_t* param)
{
    uint16 restore_bits;
    uint16 key[7];
    uint16 tmp;
...
void _rtl8307h_addrTbl_hash1_ip_restore(uint16 index, rtl8307h_lut_ipMulti_param_t* param)
{
    uint16 restore_bits;
    uint16 key[7];
    uint16 tmp;
...
int32 _rtl8307h_addrTbl_unicast_param2entry(rtk_table_list_t table, rtl8307h_tblasic_entry_t *entry, const rtl8307h_lut_uni_param_t* param)
{
    uint8 fid;
...
int32 _rtl8307h_addrTbl_unicast_entry2param(uint32 hashAlg, rtk_table_list_t table, uint32 index, rtl8307h_lut_uni_param_t* param, const rtl8307h_tblasic_entry_t *entry)
{
    uint8 fid; 
...
int32 _rtl8307h_addrTbl_multicast_param2entry(rtk_table_list_t table, rtl8307h_tblasic_entry_t *entry, const rtl8307h_lut_multi_param_t* param)
{       
    memset(entry, 0, sizeof(rtl8307h_tblasic_entry_t));
...
int32 _rtl8307h_addrTbl_multicast_entry2param(uint32 hashAlg, rtk_table_list_t table, uint32 index, rtl8307h_lut_multi_param_t* param, const rtl8307h_tblasic_entry_t *entry)
{    
...
int32 _rtl8307h_addrTbl_ip_param2entry(rtk_table_list_t table, rtl8307h_tblasic_entry_t *entry, const rtl8307h_lut_ipMulti_param_t* param)
{       
    memset(entry, 0, sizeof(rtl8307h_tblasic_entry_t));
...
int32 _rtl8307h_addrTbl_ip_entry2param(uint32 hashAlg, rtk_table_list_t table, uint32 index, rtl8307h_lut_ipMulti_param_t* param, const rtl8307h_tblasic_entry_t *entry)
{                        
...
int32 rtl8307h_addrTbl_entry2param(uint32 hashAlg, rtk_table_list_t tbl_type, uint32 index, rtl8307h_lut_param_t* param, const rtl8307h_tblasic_entry_t *entry)
{
    uint8 l3entry;
    uint8 multicast;
