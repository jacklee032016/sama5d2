...
// /home/alex/buildroot/output/host/bin/arm-buildroot-linux-uclibcgnueabihf-gcc muxir_test.c -static -o muxir_test
...
int main(int argc,char **argv)
{
	...
	//	printf("buf = 0x%x.\n", buf);
	//else
	//	printf("Non block mode, button not pressed!\n");
