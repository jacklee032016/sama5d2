...
enum attributes
{
	...
	* If you remove it, ATTR_HELLO (the first one) stops working, 
	because it then becomes the throwaway.
	*/
	ATTR_DUMMY,
	ATTR_HELLO,
	ATTR_FOO,
...
/**
* Here you can define some constraints for the attributes so Linux will validate them for you.
*/
...
/**
* Message type codes. All you need is a hello sorta function, so that's what I'm defining.
*/
enum commands
{
	COMMAND_HELLO,
...
* specific multicast groups need to register themselves to the same multicast group, too.
*/
const struct genl_multicast_group groups[] =
{
	{ 
		.name = "PotatoGroup"
	},
