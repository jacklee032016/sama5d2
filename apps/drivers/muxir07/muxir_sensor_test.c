...
/// /home/alex/buildroot/output/host/bin/arm-buildroot-linux-uclibcgnueabihf-gcc muxir_sensor_test.c -o muxir_sensor_test
...
int main(int argc,char **argv)
{
	...
	ioctl(fd, IR_READ_MODE, &read_mode);
	printf("IR read mode is: %d. 0-sensor, 1-emitter, 2-idle\n", read_mode);
