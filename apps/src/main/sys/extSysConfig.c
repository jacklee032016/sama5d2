...
void extCfgFromFactory( EXT_RUNTIME_CFG *cfg )
{
...
#endif
	cfg->ipMulticast = CFG_MAKE_IP_ADDRESS(MCAST_DEFAULT_IPADDR3, MCAST_DEFAULT_IPADDR2, MCAST_DEFAULT_IPADDR1, MCAST_DEFAULT_IPADDR0);
	...
	if(EXT_IS_TX(cfg) )
	{
//		cfg->ipAddress = CFG_MAKE_IP_ADDRESS(ETHERNET_CONF_IPADDR3_TX, ETHERNET_CONF_IPADDR2, ETHERNET_CONF_IPADDR1, ETHERNET_CONF_IPADDR0);
...
//		extMacAddressParse(&cfg->local.mac, "00:04:25:1c:20:01" );
		...
		cfg->local.ip = CFG_MAKE_IP_ADDRESS(ETHERNET_CONF_IPADDR3_TX, ETHERNET_CONF_IPADDR2_TX, ETHERNET_CONF_IPADDR1, ETHERNET_CONF_IPADDR0);
		...
		cfg->sdpUriAudio.ip = CFG_MAKE_IP_ADDRESS(ETHERNET_CONF_IPADDR3_TX, ETHERNET_CONF_IPADDR2_TX, ETHERNET_CONF_IPADDR1, ETHERNET_CONF_IPADDR0);
		...
		cfg->sdpUriVideo.ip = CFG_MAKE_IP_ADDRESS(ETHERNET_CONF_IPADDR3_TX, ETHERNET_CONF_IPADDR2_TX, ETHERNET_CONF_IPADDR1, ETHERNET_CONF_IPADDR0);
		...
		cfg->sdpUriAnc.ip = CFG_MAKE_IP_ADDRESS(ETHERNET_CONF_IPADDR3_TX, ETHERNET_CONF_IPADDR2_TX, ETHERNET_CONF_IPADDR1, ETHERNET_CONF_IPADDR0);
		...
		cfg->restUrl.ip = CFG_MAKE_IP_ADDRESS(ETHERNET_CONF_IPADDR3_TX, ETHERNET_CONF_IPADDR2_TX, ETHERNET_CONF_IPADDR1, ETHERNET_CONF_IPADDR0);
		...
		{
			cfg->dest.ip = CFG_MAKE_IP_ADDRESS(ETHERNET_CONF_IPADDR3_RX, ETHERNET_CONF_IPADDR2_TX, ETHERNET_CONF_IPADDR1, ETHERNET_CONF_IPADDR0);
			cfg->dest.audioIp = CFG_MAKE_IP_ADDRESS(ETHERNET_CONF_IPADDR3_RX+1, ETHERNET_CONF_IPADDR2_TX, ETHERNET_CONF_IPADDR1, ETHERNET_CONF_IPADDR0);
			cfg->dest.ancIp = CFG_MAKE_IP_ADDRESS(ETHERNET_CONF_IPADDR3_RX+2, ETHERNET_CONF_IPADDR2_TX, ETHERNET_CONF_IPADDR1, ETHERNET_CONF_IPADDR0);
#if EXT_FPGA_AUX_ON	
			cfg->dest.auxIp = CFG_MAKE_IP_ADDRESS(ETHERNET_CONF_IPADDR3_RX+3, ETHERNET_CONF_IPADDR2_TX, ETHERNET_CONF_IPADDR1, ETHERNET_CONF_IPADDR0);
#endif
		}
		else
		{
			cfg->dest.ip = CFG_MAKE_IP_ADDRESS(MCAST_DEFAULT_IPADDR3, MCAST_DEFAULT_IPADDR2, MCAST_DEFAULT_IPADDR1, MCAST_DEFAULT_IPADDR0);
			cfg->dest.audioIp = CFG_MAKE_IP_ADDRESS(MCAST_DEFAULT_IPADDR3+1, MCAST_DEFAULT_IPADDR2, MCAST_DEFAULT_IPADDR1, MCAST_DEFAULT_IPADDR0);
			cfg->dest.ancIp = CFG_MAKE_IP_ADDRESS(MCAST_DEFAULT_IPADDR3+2, MCAST_DEFAULT_IPADDR2, MCAST_DEFAULT_IPADDR1, MCAST_DEFAULT_IPADDR0);
#if EXT_FPGA_AUX_ON	
			cfg->dest.auxIp = CFG_MAKE_IP_ADDRESS(MCAST_DEFAULT_IPADDR3+3, MCAST_DEFAULT_IPADDR2, MCAST_DEFAULT_IPADDR1, MCAST_DEFAULT_IPADDR0);
#endif
		}
		cfg->ipGateway = CFG_MAKE_IP_ADDRESS(ETHERNET_CONF_GATEWAY_ADDR3, ETHERNET_CONF_GATEWAY_ADDR2_TX, ETHERNET_CONF_GATEWAY_ADDR1, ETHERNET_CONF_GATEWAY_ADDR0);
	...
	{/* RX */
//		cfg->ipAddress = CFG_MAKE_IP_ADDRESS(ETHERNET_CONF_IPADDR3_RX, ETHERNET_CONF_IPADDR2, ETHERNET_CONF_IPADDR1, ETHERNET_CONF_IPADDR0);
...
//		extMacAddressParse(&cfg->local.mac, "00:04:25:1c:b0:01" );
		...
		*/
		...
		cfg->local.ip = CFG_MAKE_IP_ADDRESS(ETHERNET_CONF_IPADDR3_RX, ETHERNET_CONF_IPADDR2_RX, ETHERNET_CONF_IPADDR1, ETHERNET_CONF_IPADDR0);
		...
		cfg->htmlUrl.ip = CFG_MAKE_IP_ADDRESS(ETHERNET_CONF_IPADDR3_TX, ETHERNET_CONF_IPADDR2_TX, ETHERNET_CONF_IPADDR1, ETHERNET_CONF_IPADDR0);
		cfg->htmlUrl.port = EXT_SDP_SVR_PORT;
		snprintf(cfg->restUrl.uri, sizeof(cfg->restUrl.uri), "%s", EXT_WEBPAGE_MEDIA);

		if(cfg->isMCast == EXT_FALSE)
		{
			cfg->dest.ip = CFG_MAKE_IP_ADDRESS(ETHERNET_CONF_IPADDR3_RX, ETHERNET_CONF_IPADDR2_RX, ETHERNET_CONF_IPADDR1, ETHERNET_CONF_IPADDR0);
			cfg->dest.audioIp = CFG_MAKE_IP_ADDRESS(ETHERNET_CONF_IPADDR3_RX+1, ETHERNET_CONF_IPADDR2_RX, ETHERNET_CONF_IPADDR1, ETHERNET_CONF_IPADDR0);
			cfg->dest.ancIp = CFG_MAKE_IP_ADDRESS(ETHERNET_CONF_IPADDR3_RX+2, ETHERNET_CONF_IPADDR2_RX, ETHERNET_CONF_IPADDR1, ETHERNET_CONF_IPADDR0);
#if EXT_FPGA_AUX_ON	
			cfg->dest.auxIp = CFG_MAKE_IP_ADDRESS(ETHERNET_CONF_IPADDR3_RX+3, ETHERNET_CONF_IPADDR2_RX, ETHERNET_CONF_IPADDR1, ETHERNET_CONF_IPADDR0);
#endif
		}
		else
		{
		...
		cfg->ipGateway = CFG_MAKE_IP_ADDRESS(ETHERNET_CONF_GATEWAY_ADDR3, ETHERNET_CONF_GATEWAY_ADDR2_RX, ETHERNET_CONF_GATEWAY_ADDR1, ETHERNET_CONF_GATEWAY_ADDR0);
	...
	cfg->ipSvr811 = CFG_MAKE_IP_ADDRESS(CONF_SVR811_IPADDR3, CONF_SVR811_IPADDR2, ETHERNET_CONF_IPADDR1, ETHERNET_CONF_IPADDR0);
...
#if 0
	cfg->mcIp = CFG_MAKE_IP_ADDRESS(1, 0, 0, 239);
	cfg->mcPort = 3700;
	cfg->destIp = CFG_MAKE_IP_ADDRESS(59, ETHERNET_CONF_IPADDR2, ETHERNET_CONF_IPADDR1, ETHERNET_CONF_IPADDR0);

#endif

	/* little endian */
	cfg->ipMask = CFG_MAKE_IP_ADDRESS(ETHERNET_CONF_NET_MASK3, ETHERNET_CONF_NET_MASK2, ETHERNET_CONF_NET_MASK1, ETHERNET_CONF_NET_MASK0);
